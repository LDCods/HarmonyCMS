  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" style="width: 900px;">
        <center><h2 class="form-signin-heading">Erreur 500</h2></center>
       <center><p class="lead">Le serveur a rencontré une erreur interne.</p><center>
        <div class="well"><a href="http://<?php echo $url; ?>" class="btn btn-block btn-success">Réessayer</a></div>
      </form>
