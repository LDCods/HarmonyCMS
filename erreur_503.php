  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" style="width: 900px;">
        <center><h2 class="form-signin-heading">Site indisponible</h2></center>
       <center><p class="lead">Le site est temporairement indisponible a cause d'une surcharge de visite.</p><center>
      </form>
