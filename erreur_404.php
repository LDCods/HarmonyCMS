  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" style="width: 900px;">
        <center><h2 class="form-signin-heading">Erreur 404</h2></center>
       <center><p class="lead">La page "<strong><?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REDIRECT_URL']; ?></strong>" n'existe pas ou bien elle a été déplacée.</p><center>
